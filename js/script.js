...
function generateMailToLink(subject, body, email = "info@adererror.co") {
...
function submitViaGmail() {
    ...
    const mailtoLink = `https://mail.google.com/mail/u/0/?fs=1&to=info@adererror.co&su=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}&tf=cm`;
